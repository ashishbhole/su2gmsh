      ...
      print*, "!------------------------------------------"
      print*, "Writing 3D gmsh grid file"
      ...
      do i = 1, nv
         write(10,'(I8,1X,3F20.14)') i, coord(1:3,i)  ! coordinates of each vertex
      enddo
      ...
      print*, "Finished writing 3D gmsh grid file"
      print*, "!------------------------------------------"

      end subroutine write_gmsh_3d
